...
{
    // CameraController(LateUpdate)보다 먼저 실행되어 CurrentCenter를 갱신 → 카메라 1프레임 지연 방지
    ...
    public class CameraTracker : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            // 모든 타겟을 포함하는 영역(Bounds) 계산 -> 카메라 줌아웃 크기(Size) 결정용
            ...
            // 중심점(Center) 계산 -> 포커스 포인트가 있으면 그 평균, 없으면 타겟 위치들의 평균
