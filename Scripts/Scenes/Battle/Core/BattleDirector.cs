    ...
    public class BattleDirector : MonoBehaviour
    {
        ...
        private void CheckTurnResult()
        {
            ...
            else if (enemiesSurvivors == 0)
            {
                ...
                currentRoundIndex++;
                if (currentStageData != null && currentRoundIndex >= currentStageData.rounds.Count)
                    currentRoundIndex = currentStageData.rounds.Count - 1;
        ...
        {
            if (currentStageData == null || currentStageData.rounds == null) return;
            if (currentRoundIndex >= currentStageData.rounds.Count) return;

            var currentRound = currentStageData.rounds[currentRoundIndex];
